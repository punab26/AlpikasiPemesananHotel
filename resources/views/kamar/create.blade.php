                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('kamar.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_kamar" class="form-control" id="nama_kamar" placeholder="Enter Nama Kamar">
                            @error('nama_kamar')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="ukuran_kamar" class="form-control" id="ukuran_kamar" placeholder="Enter Ukuran Kamar">
                            @error('ukuran_kamar')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
